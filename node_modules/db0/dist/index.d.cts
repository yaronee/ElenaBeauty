...
import { ConnectorOptions as ConnectorOptions$9 } from 'db0/connectors/node-sqlite3';
...
type ConnectorName = "better-sqlite3" | "sqlite" | "bun-sqlite" | "bun" | "cloudflare-d1" | "libsql-core" | "libsql-http" | "libsql-node" | "libsql" | "libsql-web" | "mysql2" | "node-sqlite3" | "pglite" | "planetscale" | "postgresql";
type ConnectorOptions = {
    "better-sqlite3": ConnectorOptions$1;
    /** @deprecated Alias of better-sqlite3 */
    "sqlite": ConnectorOptions$1;
    ...
    "node-sqlite3": ConnectorOptions$9;
...
declare const connectors: Readonly<{
    ...
    readonly "node-sqlite3": "db0/connectors/node-sqlite3";
...
export { type Connector, type ConnectorName, type ConnectorOptions, type Database, type ExecResult, type Primitive, type SQLDialect, type Statement, connectors, createDatabase };
