...
import { f as commands, c as cwdArgs, s as setupGlobalConsole, g as checkEngines, a as logger } from './cli.DBd-hElG.mjs';
import { resolve } from 'node:path';
import { provider } from 'std-env';
import { d as description, v as version, n as name } from './cli.WDXJgBkr.mjs';
