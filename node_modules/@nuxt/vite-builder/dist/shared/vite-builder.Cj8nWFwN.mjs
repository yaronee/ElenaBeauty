        ...
        build: {
          ...
          rollupOptions: {
            output: {
              ...
              assetFileNames: nuxt.options.dev ? undefined : (chunk) => withoutLeadingSlash(join(nuxt.options.app.buildAssetsDir, `${sanitizeFilePath(filename$1(chunk.names[0]))}.[hash].[ext]`))
            }
          },
          watch: {
